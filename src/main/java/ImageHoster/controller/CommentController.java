...
public class CommentController {
    ...
    public String createComment(@PathVariable("imageTitle") String title, @PathVariable("imageId") Integer id, @RequestParam("comment") String comment, Comment newComment, RedirectAttributes redirectAttributes, HttpSession session) throws IOException {
        if (!comment.equals("")) {
            ...
            redirectAttributes.addAttribute("commentError", error).addFlashAttribute("commentError", error);
        }
